...
If this book has been valuable to you and you wish to support our family's evacuation and the continuation of my research on algorithmic thinking in the age of AI, 
any contribution is deeply appreciated.

You can contribute through any of the following options:

* **PayPal:** `[Insert your PayPal email or paypal.me link]` *(Recommended for credit/debit card transfers worldwide)*
* **Cryptocurrency (USDT — TRC-20 Network):** `[Insert your USDT TRC-20 address]` *(USDT is a 1:1 USD stablecoin; network transfer fee is ~\$1–2, address starts with "T")*
* **Bitcoin (BTC):** `[Insert your BTC Wallet address]` *(Optional)*
* **Ethereum (ETH):** `[Insert your ETH Wallet address]` *(Optional)*
* **Direct Card Payment / Monobank:** `[Insert link to Monobank Jar or Card payment page]` *(Direct card payment option)*

> **As a token of my gratitude:** All supporters receive access to the full collection of editable DRAKON diagrams and automatically
 generated JavaScript source code on GitHub to study, modify, and experiment with visual algorithms.

---

**With best wishes,**  
**Sergey Ivanov**  
*Author of Data Structures & Algorithms (DrakonTech & JavaScript)*
```

---

💡 *После того как `README.md` сохранится нормально, подготовим версию файла в формате `.adoc` для раздела книги в Antora?*
