...
//image::{imagesdir}/Fig6_1_searchElement_v2.png[width=50%]
...
//image::{imagesdir}/Fig6_2_dataSorted.png[width=50%]
...
//image::{imagesdir}/Fig6_3_searchValue.png[width=50%]
image::{imagesdir}/Fig6_3_searchValue.png[width=50%, link="{imagesdir}/Fig6_3_searchBinary.svg", window="_blank"]
...
//image::{imagesdir}/Fig6_4a_main.png[width=50%]
...
image::{imagesdir}/Fig6_4b_pushFront.png[width=20%, link="{imagesdir}/Fig6_4b_pushFront.svg", window="_blank"]

//image::{imagesdir}/Fig6_4b_pushBack.png[width=75%]
image::{imagesdir}/Fig6_4b_pushBack.png[width=20%, link="{imagesdir}/Fig6_4b_pushBack.svg", window="_blank"]
...
image::{imagesdir}/Fig6_4c_searchData.png[width=40%, link="{imagesdir}/Fig6_4c_searchData.svg", window="_blank"]
...
image::{imagesdir}/Fig6_4d_removeVal.png[width=40%, link="{imagesdir}/Fig6_4d_removeVal.svg", window="_blank"]

[.text-center]
e). function of searching _SearchData(val)_
+

image::{imagesdir}/Fig6_4d_PushVal.jpg[width=50%]

[.text-center]
g). function of inserting by value _PushVal + NodeWithVal_
