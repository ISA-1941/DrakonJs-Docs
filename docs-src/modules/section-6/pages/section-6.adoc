...
//image::{imagesdir}/Fig6_4c_searchData.png[width=50%]
...
image::{imagesdir}/Fig6_4d_removeVal.png[width=100%, link="{imagesdir}/Fig6_4d_removeVal.svg", window="_blank"]
...
//image::{imagesdir}/Fig6_4d_removeVal.png[width=100%]
image::{imagesdir}/Fig6_4e_pushVal.png[width=100%, link="{imagesdir}/Fig6_4e_pushVal.svg", window="_blank"]

//image::{imagesdir}/Fig6_4e_nodeWithVal.png[width=100%]
image::{imagesdir}/Fig6_4e_nodeWithVal.png[width=100%, link="{imagesdir}/Fig6_4e_nodeWithVal.svg", window="_blank"]

[.text-center]
f). function of removing duplicates _removeDupli_

//image::{imagesdir}/Fig6_4f_removeDupli.png[width=100%]
image::{imagesdir}/Fig6_4f_removeDupli.png[width=100%, link="{imagesdir}/Fig6_4f_RemoveDupli.svg", window="_blank"]
