...
//image::{imagesdir}/Fig6_5a_hashInserr.png[idth=75%]
...
//image::{imagesdir}/Fig6_5b_searchHash.png[idth=75%]
...
//image::{imagesdir}/Fig6_5c_hashRemove.png[width=75%]
image::{imagesdir}/Fig6_5c_hashRemove.png[width=75%, link="{imagesdir}/Fig6_5c_hashRemove.svg", window="_blank"]
...
image::{imagesdir}/Fig6_5d_hashRemove.png[idth=75%]

[.text-center]
Figure 6.5. Deletion item from hash-table
