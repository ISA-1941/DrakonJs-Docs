...
//..image::{imagesdir}/Fig6_1_searchValue.svg[width=50%]

image::{imagesdir}/Fig6_1_searchValue.png[width=50%]
image::{imagesdir}/Fig6_1_searchValue.png[width=50%, link="{imagesdir}/Fig6_1_searchValue.svg", window="_blank"]
...
image::{imagesdir}/Fig6_2_dataSorted.svg[width=50%]
...
image::{imagesdir}/Fig6_3_searchBinary.svg[width=50%]
...
image::{imagesdir}/Fig6_4a_main.svg[width=50%]
...
image::{imagesdir}/Fig6_4b_searchData.svg[width=140%]
