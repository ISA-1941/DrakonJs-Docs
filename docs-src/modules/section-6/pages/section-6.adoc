...
//image::{imagesdir}/Fig6_4d_removeVal.png[width=50%]
...
//image::{imagesdir}/Fig6_4e_nodeWithVal.png[width=50%]
...
//image::{imagesdir}/Fig6_4f_removeDupli.png[width=50%]
image::{imagesdir}/Fig6_4f_removeDupli.png[width=50%, link="{imagesdir}/Fig6_4f_RemoveDupli.svg", window="_blank"]
