...
associative array that allows you to store key-value pairs and perform three basic operations: 
...
image::{imagesdir}/Fig6_5a_createHashTable.png[width=75%]
...
image::{imagesdir}/Fig6_5b_createNodes.png[width=75%]
