...
| 6. | Hash Table Creation | Creating a Hash Table Structure
| 6.x | Hash Table Search | Searching for an Element by Key
| 6.x | Hash Table Traversal | Traversing Hash Table Items
| 6.x | Hash Table Deletion | Deleting an Element by Key
|=== 
...
image::{imagesdir}/Fig6_5d_hashRemove.png[width=50%, link="{imagesdir}/Fig6_5d_hashRemove.svg", window="_blank"]
