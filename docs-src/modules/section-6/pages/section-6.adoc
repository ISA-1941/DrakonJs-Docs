...
image::{imagesdir}/Fig6_4b_pushFront.png[width=75%, link="{imagesdir}/Fig6_4b_pushFront.svg", window="_blank"]

//image::{imagesdir}/Fig6_4b_pushBack.png[width=75%]
image::{imagesdir}/Fig6_4b_pushBack.png[width=75%, link="{imagesdir}/Fig6_4b_pushBack.svg", window="_blank"]
...
image::{imagesdir}/Fig6_4c_Remove.jpg[width=80%]

[.text-center]
d). function of deletion _RemoveVal(val)_

image::{imagesdir}/Fig6_4d_SearchData.jpg[width=50%]
