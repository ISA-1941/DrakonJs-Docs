...
image::{imagesdir}/Fig6_5a_Description.jpg[idth=75%, height=30%, align=center]
...
image::{imagesdir}/Fig6_HashEmpty.jpg[idth=75%, height=30%, align=center]
...
image::{imagesdir}/Fig6_Hash119.jpg[idth=75%, height=30%, align=center]
...
image::{imagesdir}/Fig6_HashTable.jpg[idth=75%, height=30%, align=center]
...
image::{imagesdir}/Fig6_6_HDia_ab.jpg[idth=75%, height=30%, align=center]

[.text-center]
a). Hash-table creating function b). Item searching function

image::{imagesdir}/Fig6_6_HDia_cd.jpg[idth=75%, height=30%, align=center]
...
image::{imagesdir}/Fig6_6_DeletionItem.jpg[idth=75%, height=30%, align=center]
