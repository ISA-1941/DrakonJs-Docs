...
//image::{imagesdir}/Fig8_27_deleteNode.svg[width=75%]
image::{imagesdir}/Fig8_27_deleteNode.svg[width=75%, link="{imagesdir}/Fig8_27_deleteNode.svg", window="_blank"]
...
image::{imagesdir}/Fig8_30_createNodeTree.png[width=100%]
...
image::{imagesdir}/Fig8_31_rotates.png[width=75%]
image::{imagesdir}/Fig8_31_rotates.png[width=75%, link="{imagesdir}/Fig8_31_rotates.svg", window="_blank"]
...
The different nodeImages representing possible configurations of red and black nodes are summarized in Table 8.3. 

:!table-caption:
.Table 8.3 — NodeImages for Red-Black Tree Insertion Cases
|===
...
//image::{imagesdir}/Fig8_42_Fig8_42a_fixDoubleBlack.png[width=80%]
image::{imagesdir}/Fig8_42_Fig8_42a_fixDoubleBlack.png[width=100%, link="{imagesdir}/Fig8_42_Fig8_42a_fixDoubleBlack.svg", window="_blank"]
