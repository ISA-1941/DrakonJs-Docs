...
"D:\GitWorks\DrakonJsLocal\Project_Book\docs-src\modules\section-8\assets\images\part_4\Fig8_32_rbInsert.png"
[.text-center]
...
The DRAKON-diagram of the red-black tree balancing algorithm when entering a new node is shown in Figure 8.33.
