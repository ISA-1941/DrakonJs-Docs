...
iimage::{imagesdir}/Fig8_1_Term.jpg[width=75%]
...
iimage::{imagesdir}/Fig8_2_BST.jpg[width=75%]
...
iimage::{imagesdir}/Fig8_3a_insertNode.jpg[width=75%]

iimage::{imagesdir}/Fig8_3b_createNode.jpg[width=75%]
...
iimage::{imagesdir}/Fig8_4_treeProcess.jpg[width=75%]
...
iimage::{imagesdir}/Fig8_5_findNode.jpg[width=75%]
...
iimage::{imagesdir}/Fig8_6_del21.png[width=75%]
...
iimage::{imagesdir}/Fig8_7_del19.png[width=75%]
...
iimage::{imagesdir}/Fig8_8_del8.png[width=75%]
...
iimage::{imagesdir}/Fig8_9_del5.png[width=75%]
...
iimage::{imagesdir}/Fig8_10_findMin.png[width=75%]
...
iimage::{imagesdir}/Fig8_11_removeNode.svg[width=75%]
...
iimage::{imagesdir}/Fig8_12_PreInPost.jpg[width=75%]
...
iimage::{imagesdir}/Fig8_14_idealTree.jpg[width=75%]
...
image::{imagesdir}/Fig8_15_buildingAvlTree.jpg[width=75%]
...
iimage::{imagesdir}/Fig8_16_RR_turn.jpg[width=75%]
...
iimage::{imagesdir}/Fig8_17_LL_turn.jpg[width=75%]
...
iimage::{imagesdir}/Fig8_18_RL_turn.jpg[width=75%]
...
iimage::{imagesdir}/Fig8_19_LR_turn.jpg[width=75%]
...
iimage::{imagesdir}/Fig8_20_insertNode.svg[width=75%]
...
iimage::{imagesdir}/Fig8_21_avlRotateIinsert.svg[width=75%]
...
iimage::{imagesdir}/Fig8_22_twoRotates.jpg[width=75%]
...
[.text-center]
iimage::{imagesdir}/Fig8_23_exampleLL.jpg[width=75%]
...
iimage::{imagesdir}/Fig8_24_avlTreeProcess.jpg[width=75%]
...
iimage::{imagesdir}/Fig8_25_avlfindNode.svg[width=75%]
...
iimage::{imagesdir}/Fig8_26_varDelNode.jpg[width=75%]
...
iimage::{imagesdir}/Fig8_27_varDelNode.jpg[width=75%]
...
iimage::{imagesdir}/Fig8_28_mainFunction.jpg[width=75%]
...
iimage::{imagesdir}/Fig8_29_redblackTree.png[width=75%]
...
iimage::{imagesdir}/Fig8_30_createNodeTree.png[width=75%]
...
iimage::{imagesdir}/Fig8_30_rotateLeft.jpg[width=75%]
...
iimage::{imagesdir}/Fig8_32_Insert.jpg[width=75%]
...
iimage::{imagesdir}/Fig8_33_family.jpg[width=75%]
...
iimage::{imagesdir}/Fig8_34_fixRedRed.svg[width=75%]

[.text-center]
Figure 8.35. Red-Black Tree Balancing Algorithm DRAKON-diagram 


iimage::{imagesdir}/Fig8_35_diagr_figs.svg[width=75%]
...
iimage::{imagesdir}/Fig8_36a_rotateLeft.png[width=75%]

iimage::{imagesdir}/Fig8_36b_rotateRight.png[width=75%]
...
iimage::{imagesdir}/Fig8_37_rbProcess.jpg[width=75%]
...
iimage::{imagesdir}/Fig8_38a_mindMap_deleteNode.jpg[width=75%]

iimage::{imagesdir}/Fig8_38b_deleteNode.jpg[width=75%]
...
iimage::{imagesdir}/Fig8_39a_fixDoubleBlack.png[width=75%]

iimage::{imagesdir}/Fig8_39b_fixDoubleBlackStep.svg[width=75%]
...
| iimage::{imagesdir}/before_join.png[] | iimage::{imagesdir}/after_join.png[]
|===

.Figure 8.X — Replacing a node in a red-black tree using `joinParentChild`
[caption="Figure 8.X", align="center"]
iimage::{imagesdir}/Fig8_joinPC.png[width=80%]
[.text-center]
