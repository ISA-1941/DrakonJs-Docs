...
In the most general way the red-black tree construction algorithm is presented by the function `rbInsert(tree, key)`(Figure 8.32)
...
==== 8.4.1.2. Rebalancing After Insertion — Video Examples
