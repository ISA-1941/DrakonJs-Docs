...
DRAKON-diagram of the node removal algorithm is shown in Figures 8.37a,b. This
...
image::{imagesdir}/Fig8_38a_fixDoubleBlack.png[width=75%]
//image::{imagesdir}/Fig8_38b_fixDoubleBlackStep.png[width=75%]
image::{imagesdir}/Fig8_38b_fixDoubleBlackStep.png[width=75%]/Fig8_38b_fixDoubleBlackStep.svg", window="_blank"]
