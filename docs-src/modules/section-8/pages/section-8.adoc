...
image::{imagesdir}/Fig8_3a_insert.png[width=75%, link="{imagesdir}/Fig8_3a_insert.svg", window="_blank"]

//image::{imagesdir}/Fig8_3b_createNode.jpg[width=50%]
image::{imagesdir}/ig8_3b_createNode.png[width=75%, link="{imagesdir}/ig8_3b_createNode.svg", window="_blank"]
...
image::{imagesdir}/Fig8_4_treeProcess.jpg[width=10%]
...
image::_images/Fig8_15_buildingAvlTree.png[width=75%]
