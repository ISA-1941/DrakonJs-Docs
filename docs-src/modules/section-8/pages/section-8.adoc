...
//image::{imagesdir}/Fig8_1_Term.jpg[width=75%, link="{imagesdir}/Fig8_1_Term.jpg", window="_blank"]
...
image::{imagesdir}/Fig8_3a_insert.png[width=75%, link="{imagesdir}/Fig8_3a_insert.png", window="_blank"]


//image::{imagesdir}/Fig8_3b_createNode.jpg[width=25%]
image::{imagesdir}/Fig8_3b_createNode.jpg[width=75%, link="{imagesdir}/Fig8_3b_createNode.jpg", window="_blank"]
...
image::{imagesdir}/Fig8_4_treeProcess.jpg[width=75%, link="{imagesdir}/Fig8_4_treeProcess.jpg", window="_blank"]
...
image::{imagesdir}/Fig8_5_findNode.jpg[width=75%, link="{imagesdir}/Fig8_5_findNode.jpg", window="_blank"]
[.text-center]
...
//image::{imagesdir}/Fig8_6_del21.jpg[width=75%] Fig8_6_del21.jpg
image::{imagesdir}/Fig8_6_del21.jpg[width=75%, link="{imagesdir}/Fig8_6_del21.jpg", window="_blank"]
