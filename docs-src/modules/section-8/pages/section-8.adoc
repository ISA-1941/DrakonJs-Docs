...
//image::{imagesdir}/Fig8_31_rotateLeft.png[width=75%]
image::{imagesdir}/Fig8_31_rotateLeft.png[width=75%, link="{imagesdir}/Fig8_31_rotateLeft.svg", window="_blank"]
...
//image::{imagesdir}/Fig8_34_fixRedRed.png[width=75%]
image::{imagesdir}/Fig8_34_fixRedRed.png[width=75%, link="{imagesdir}/Fig8_34_fixRedRed.svg", window="_blank"]
