...
The following video demonstrations show the cluster adjustment process during node insertion in Red-Black trees.

.Video 1: Initial node insertion and violation detection
video::{video-dir}/rb-tree-insertion-1.mp4[width={video-width}, options=controls]

.Video 2: First rotation and color adjustment  
video::{video-dir}/rb-tree-insertion-2.mp4[width={video-width}, options=controls]

.Video 3: Second rotation for tree balancing
video::{video-dir}/rb-tree-insertion-3.mp4[width={video-width}, options=controls]

.Video 4: Final cluster reorganization
video::{video-dir}/rb-tree-insertion-4.mp4[width={video-width}, options=controls]

.Video 5: Complete insertion process overview
video::{video-dir}/rb-tree-insertion-5.mp4[width={video-width}, options=controls]
