...
//image::{imagesdir}/Fig8_5_findNode.jpg[width=100%]
image::{imagesdir}/Fig8_5_findNode.jpg[width=100%, link="{imagesdir}/Fig8_5_findNode.svg", window="_blank"]
...
//image::{imagesdir}/Fig8_21_avlRotateIinsert.png[width=75%]
image::{imagesdir}/Fig8_21_RotateIinsert.png[width=100%, link="{imagesdir}/Fig8_21_RotateIinsert.svg", window="_blank"]
...
image::{imagesdir}/Fig8_22_twoRotates.png[width=75%]
image::{imagesdir}/Fig8_22_twoRotates.png[width=100%, link="{imagesdir}/Fig8_22_twoRotates.svg", window="_blank"]
