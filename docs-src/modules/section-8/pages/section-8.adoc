...
The DRAKON-diagrams of rotate functions are presented on Figure 8.33a,b.

image::{imagesdir}/Fig8_33_rotates.png[width=75%]
image::{imagesdir}/Fig8_33_rotates.png[width=75%, link="{imagesdir}/Fig8_31_rotates.svg", window="_blank"]

[.text-center]
Figure 8.32. Rotate function DRAKON-diagrams (a - rotateLeft; b - rotate right)  
...
image::{imagesdir}/Fig8_34_fixRedRed.png[width=100%, link="{imagesdir}/Fig8_34_fixRedRed.svg", window="_blank"]

[.text-center]
.Figure 8.34. Red-Black Tree Balancing Algorithm DRAKON-diagram 


//image::{imagesdir}/Fig8_35_diagr_figs.png[width=75%]
image::{imagesdir}/Fig8_35_diagr_figs.png[width=100%, link="{imagesdir}/Fig8_35_diagr_figs.svg", window="_blank"]
...
The Drakon-diagram of the node rotation algorithms to the red and black tree cluster is shown in Figure 8.36a,b.

//image::{imagesdir}/Fig8_36a_rotateLeft.png[width=75%]
image::{imagesdir}/Fig8_36a_rotateLeft.png[width=100%, link="{imagesdir}/Fig8_36a_rotateLeft.svg", window="_blank"]

//image::{imagesdir}/Fig8_36b_rotateRight.png[width=75%]
image::{imagesdir}/Fig8_36b_rotateRight.png[width=100%, link="{imagesdir}/Fig8_36b_rotateRight.svg", window="_blank"]
