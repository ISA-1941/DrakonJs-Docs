...
| image::{imagesdir}/Fig8_30b_createTree.png[width=50%]
|===

image::{imagesdir}/Fig8_30a_createNode.png[[pdfwidth=6cm]]
image::{imagesdir}/Fig8_30b_createTree.png[[pdfwidth=6cm]]
