...
"D:\GitWorks\DrakonJsLocal\Project_Book\docs-src\modules\section-8\assets\images\Fig8_14_idealTree.jpg"
...
image::{imagesdir}/Fig8_2_BST.jpg[width=75%]
...
image::{imagesdir}/Fig8_3a_insertNode.jpg[width=75%]

image::{imagesdir}/Fig8_3b_createNode.jpg[width=75%]
