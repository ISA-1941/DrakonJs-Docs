...
video::{video-dir}/case1.mp4[width={video-width}, options=controls]

.Video 2: First rotation and color adjustment  
video::{video-dir}/case2.mp4[width={video-width}, options=controls]

.Video 3: Second rotation for tree balancing
video::{video-dir}/case3.mp4[width={video-width}, options=controls]

.Video 4: Final cluster reorganization
video::{video-dir}/case4.mp4[width={video-width}, options=controls]

.Video 5: Complete insertion process overview
video::{video-dir}case5.mp4[width={video-width}, options=controls]
