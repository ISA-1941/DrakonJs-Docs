...
image::{imagesdir}/Fig7_8_Tree.svg[width=50%, link="{imagesdir}/Fig7_8_Tree.svg", window="_blank"]
...
image::{imagesdir}/Fig7_9_All.svg[width=50%, link="{imagesdir}/Fig7_9_All.svg", window="_blank"]
