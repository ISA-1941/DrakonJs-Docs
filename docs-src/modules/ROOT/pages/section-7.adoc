...
image::section_1/Fig7_1b_bubbleSort.svg[width=75%, link="self", window="_blank"]
[.text-center]
...
image::Fig7_2b_selectSort.svg[opts=interactive, width=50%, link=self, window="_blank"]
...
image::Fig7_3b_insertSort.svg[opts=interactive, width=50%, link=self, window="_blank"]
[.text-center]
...
image::Fig7_4b_quickSort.svg[opts=interactive, width=50%, link=self, window="_blank"]
...
.а) 
image::Fig7_5b_merge.svg[opts=interactive, width=50%, link=self, window="_blank"]
.b)
image::Fig7_5c_mergeSorting.svg[opts=interactive, width=50%, link=self, window="_blank"]
...
image::Fig7_7b_shellSort.svg[opts=interactive, width=50%, link=self, window="_blank"]
...
image::Fig7_8_Tree.svg[opts=interactive, width=50%, link=self, window="_blank"]
...
image::Fig7_9_All.svg[opts=interactive, width=50%, link=self, window="_blank"]
...
image::{imagesdir}/Fig7_10b_heapSort.svg[opts=interactive, width=50%, link=self, window="_blank"]
image::{imagesdir}/Fig7_10c_heapify.svg[opts=interactive, width=50%, link=self, window="_blank"]
