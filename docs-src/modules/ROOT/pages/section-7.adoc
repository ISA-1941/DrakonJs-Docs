...
.b)
image::section_7/Fig7_5c_mergeSorting.svg[width=50%, link=self, window="_blank"]
...
image::section_7/Fig7_6_mergeScheme.png[width=50%, link=self, window="_blank"]
[.text-center]
...
image::section_7/Fig7_8_Tree.svg[width=50%, link=self, window="_blank"]
...
image::section_7/Fig7_9_All.svg[width=50%, link=self, window="_blank"]
