...
image::section_7/Fig7_10b_heapSort.svg[opts=interactive, width=50%, link=self, window="_blank"]
image::section_7/Fig7_10c_heapify.svg[opts=interactive, width=50%, link=self, window="_blank"]
