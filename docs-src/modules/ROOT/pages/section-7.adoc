...
image::{imagesdir}/Fig7_4_quickSort.svg[width=50%, link="{imagesdir}/Fig7_4_quickSort.svg", window="_blank"]
...
image::{imagesdir}/Fig7_7_shellSort.svg[width=50%, link="{imagesdir}/Fig7_7_shellSort.svg", window="_blank"]
...
image::{imagesdir}/Fig7_8_Tree.jpg[width=50%, link="{imagesdir}/Fig7_8_Tree.jpg", window="_blank"]
...
image::{imagesdir}/Fig7_9_All.jpg[width=50%, link="{imagesdir}/Fig7_9_All.jpg", window="_blank"]
...
image::{imagesdir}/Fig7_10a_heapSort.svg[width=50%, link="{imagesdir}/Fig7_10a_heapSort.svg", window="_blank"]
image::{imagesdir}/Fig7_10b_heapify.svg[width=50%, link="{imagesdir}/Fig7_10b_heapify.svg", window="_blank"]
