[.text-justify]
== Welcome to the DRAKON-JS Project
...
*SECTION 10* provides basic information about data structure selection, 
including criteria for choosing appropriate data structures based 
