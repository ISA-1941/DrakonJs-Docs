...
image::section_9/Fig9_7a_DFS_stack.svg[width=75%, link=self, window="_blank"]

[.text-center]
.Figure 9.7b. Drakon-diagram illustrating the control flow of BFS (Breadth-First Search)
image::section_9/Fig9_7b_BFS_queue.svg[width=75%, link=self, window="_blank"]
...
image::section_9/Fig9_8_searchContext.svg[width=50%, link=self, window="_blank"]
...
image::section_9/Fig9_14_backtrackFromNeighbor.svg[width=50%, link=self, window="_blank"]
