...
- Loops: This is a critical point for this textbook. In an undirected graph, a loop is counted twice (+2 to the degree). Why? Because both ends of the 
    loop-edge are "plugged into" the same vertex, and each end contributes to the degree.
...
- Loops in a Digraph: In this case, a loop is counted exactly once for the in-degree and once for the out-degree. It does not "double" the total degree in the 
same way as in an undirected graph; instead, it is honestly distributed between the two directions.
...
[.text-center]
.a). Drakon-diagram illustrating the control flow of DFS (Depth-First Search)
image::section_9/Fig9_6a_DFS_stack.svg[width=75%, link=self, window="_blank"]

[.text-center]
.b). Drakon-diagram illustrating the control flow of BFS (Breadth-First Search)
...
image::section_9/iFig9_9_initPathSearch.svg[width=50%, link=self, window="_blank"]
...
image::section_9/iFig9_10_findPathWithContext.svg[width=50%, link=self, window="_blank"]
...
image::section_9/iFig9_11_handleFoundPath.svg[width=50%, link=self, window="_blank"]
...
image::section_9/iFig9_12_prepareMoveToNeighbor.svg[width=50%, link=self, window="_blank"]
...
image::section_9/iFig9_13_backtrackFromNeighbor.svg[width=50%, link=self, window="_blank"]
...
image::section_9/Fig9_15_Dijkstra_classic.svg[width=50%, link=self, window="_blank"]
...
image::section_9/Fig9_16_dijkstra.svg[width=50%, link=self, window="_blank"]
...
image::section_9/Fig9_17_init.svg[width=50%, link=self, window="_blank"]
...
image::section_9/Fig9_18_findMinDistanceVertex.svg[width=50%, link=self, window="_blank"]
...
image::section_9/Fig9_19_markVertexVisited.svg[width=50%, link=self, window="_blank"]
...
[.text-center]
image::section_9/Fig9_20_relaxEdges.svg[width=50%, link=self, window="_blank"]
