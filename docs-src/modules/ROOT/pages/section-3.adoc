...
[.text-center]
.Figure 3.3. Map
image::section_3/Fig3_3_Map.svg[width=100%, link=self, window="_blank"]
...
image::section_3/Fig3_7_Term.svg[width=100%, height=40%, align=center]
...
[.text-center]
.Figure 3.8. Binary tree structure (value - value (key), N - NULL)
image::section_3/Fig3_8_BST.svg[width=100%, link=self, window="_blank"]
...
[.text-center]
.Figure 3.9. The view of (a) undirected and (b) directed graphs
image::section_3/Fig3_9_Graphes.jpg[width=100%, link=self, window="_blank"]
