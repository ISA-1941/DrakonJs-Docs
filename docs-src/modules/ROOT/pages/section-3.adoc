...
image::section_3/Fig3_1_Array.svg[width=400,height=200,align=center]
...
image::section_3/Fig3_2_Slice.svg[width=600,height=200,align=center]
...
image::{imagesdir}/Fig3_9_Graphes.jpg[width=100%]
