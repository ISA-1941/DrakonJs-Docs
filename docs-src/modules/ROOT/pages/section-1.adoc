...
image::section_1/Fig1_2_Array.svg[width=100%, link=self, window="_blank"]
...
image::section_1/Fig1_3_ll.svg[width=100%, link=self, window="_blank"]
...
image::section_1/Fig1_5_Queue.svg[width=100%, link=self, window="_blank"]
...
image::section_1/Fig1_6_Tree.svg[width=100%, link=self, window="_blank"]
