...
image::section_1/Fig1_4_Stack.svg[width=100%, link=self, window="_blank"]
...
image::section_1/Fig1_6_Tree.svg[width=75%, height=34%, align=center]
...
image::section_1/Fig1_7_Graph.svg[width=75%, height=34%, align=center]
