...
image::section_1/Fig1_2_Array.svg[width=200%, link=self, window="_blank"]
[.text-center]
...
image::{imagesdir}/Fig1_3_ll.jpg[width=75%] 
...
image::{imagesdir}/Fig1_4_Stack.jpg[width=40%]
...
image::{imagesdir}/Fig1_5_Queue.jpg[width=75%]
